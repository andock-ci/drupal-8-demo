...
$settings['install_profile'] = 'schaer_install';
$settings['hash_salt'] = 'salt';

$config_directories[CONFIG_SYNC_DIRECTORY] = '../config/%%PROJECT%%_sync';
...
$settings['file_private_path'] = 'sites/%%PROJECT%%-%%ENV%%/files-private';